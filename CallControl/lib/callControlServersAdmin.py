#-------------------------------------------------------------------------------
# Name:         callControlServersAdmin
# Purpose:      This class defines the methods needed to fulfill remote requests
#               to start and stop UI_Control 'sessions' on each machine involved
#               in execution of a UI_Control-enabled test suite.
#
# Author:       rashforth
#
# Created:      29/09/2012
