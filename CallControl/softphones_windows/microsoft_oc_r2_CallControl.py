#-------------------------------------------------------------------------------
# Name:        microsoft_oc_r2_CallControl
# Purpose:     This is the microsoft_oc_r2-specific iUI_CallControl interface
...
class Microsoft_oc_r2_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Microsoft_oc_r2_CallControl, self).log_method_called(self.phone_name, methodname)
