#-------------------------------------------------------------------------------
# Name:        cucimoc_CallControl
# Purpose:     This is the cucimoc-specific iUI_CallControl interface class,
...
class Cucimoc_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Cucimoc_CallControl, self).log_method_called(self.phone_name, methodname)
