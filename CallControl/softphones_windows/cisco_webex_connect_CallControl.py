#-------------------------------------------------------------------------------
# Name:        cisco_webex_connect_CallControl
# Purpose:     This is the cisco_webex_connect-specific iUI_CallControl
...
class Cisco_webex_connect_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Cisco_webex_connect_CallControl, self).log_method_called(self.phone_name, methodname)
