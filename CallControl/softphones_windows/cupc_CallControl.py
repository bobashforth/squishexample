#-------------------------------------------------------------------------------
# Name:        cupc_CallControl
# Purpose:     This is the cupc-specific iUI_CallControl interface class,
...
class Cupc_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Cupc_CallControl, self).log_method_called(self.phone_name, methodname)
