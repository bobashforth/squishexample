#-------------------------------------------------------------------------------
# Name:        avaya_ip_softphone_CallControl
# Purpose:     This is the avaya_ip_softphone-specific iUI_CallControl
...
class Avaya_ip_softphone_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Avaya_ip_softphone_CallControl, self).log_method_called(self.phone_name, methodname)
