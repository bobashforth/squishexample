#-------------------------------------------------------------------------------
# Name:        avaya_onex_agent_CallControl
# Purpose:     This is the avaya_onex_agent-specific iUI_CallControl
...
class Avaya_onex_agent_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Avaya_onex_agent_CallControl, self).log_method_called(self.phone_name, methodname)
