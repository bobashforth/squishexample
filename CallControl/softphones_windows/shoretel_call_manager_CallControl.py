#-------------------------------------------------------------------------------
# Name:        shoretel_call_manager_CallControl
# Purpose:     This is the shoretel_call_manager-specific iUI_CallControl
...
class Shoretel_call_manager_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Shoretel_call_manager_CallControl, self).log_method_called(self.phone_name, methodname)
