#-------------------------------------------------------------------------------
# Name:        cucilync_CallControl
# Purpose:     This is the cucilync-specific iUI_CallControl interface class,
...
class Cucilync_CallControl(uicc.UI_CallControl):

    def PlaceCall(self, operation_type, contact):
        status = ccc.STATUS_SUCCESS
        methodname = 'PlaceCall'

        super(Cucilync_CallControl, self).log_method_called(self.phone_name, methodname)
        ...
        if status == ccc.STATUS_SUCCESS:
            ...
            if operation_type == ccc.OT_PHONE_NUMBER_MAIN_WND:
                ...
                pass
            elif operation_type == ccc.OT_DRAGDROP_TO_PHONE_MENU:
                pass
    ...
    def TwoCalls(self, operation_type, contact):
        ...
        if not isvalid_func_op(ccc.TWO_CALLS, operation_type):
            ...
            if operation_type in [ccc.OT_TWO_CALLS_ONHOLDMUTED_DIALING]:
                status = ccc.STATUS_FEATURE_NOT_SUPPORTED
